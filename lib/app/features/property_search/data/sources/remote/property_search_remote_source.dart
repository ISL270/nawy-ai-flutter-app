...
@singleton
class PropertySearchRemoteSource {
  ...
  PropertySearchResponse? _cachedSearchResponse;

  PropertySearchRemoteSource(DioClient dioClient); // Keep parameter for dependency injection
  ...
  Future<PropertySearchResponse> _loadSearchResponseFromLocal() async {
    ...
    _cachedSearchResponse = PropertySearchResponse.fromJson(jsonData);
    return _cachedSearchResponse!;
  }
