...
void main() {
  group('SearchResponse Tests', () {
    late Map<String, dynamic> validSearchResponseJson;

    setUp(() {
      validSearchResponseJson = {
        'total_compounds': 0,
    ...
    group('JSON Deserialization', () {
      test('should deserialize valid search response JSON', () {
        // Act
        final result = SearchResponse.fromJson(validSearchResponseJson);
      ...
      test('should handle empty properties list', () {
        ...
        // Act
        final result = SearchResponse.fromJson(emptyJson);
      ...
      test('should handle missing property_types field', () {
        ...
        // Act
        final result = SearchResponse.fromJson(jsonWithoutPropertyTypes);
    ...
    group('Properties Validation', () {
      ...
      test('should handle properties with all fields', () {
        // Arrange
        final fullPropertyJson = Map<String, dynamic>.from(validSearchResponseJson);
        ...
        // Act
        final result = SearchResponse.fromJson(fullPropertyJson);
    ...
    group('JSON Serialization', () {
      test('should serialize back to JSON correctly', () {
        // Arrange
        final searchResponse = SearchResponse.fromJson(validSearchResponseJson);
    ...
    group('Pagination Metadata', () {
      ...
      test('should handle large totals correctly', () {
        ...
        // Act
        final result = SearchResponse.fromJson(largeDataJson);
