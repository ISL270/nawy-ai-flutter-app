...
void main() {
  group('PropertyRepository Tests', () {
    ...
    late MockPropertyRemoteSource mockRemoteSource;

    setUp(() {
      mockRemoteSource = MockPropertyRemoteSource();
      repository = PropertyRepository(mockRemoteSource);
    });
    ...
    group('searchProperties', () {
      test('should return search response when remote source succeeds', () async {
        ...
        when(() => mockRemoteSource.searchProperties(
        ...
        verify(() => mockRemoteSource.searchProperties(
          areaIds: [1, 2],
          compoundIds: null,
          minPrice: 500000,
          maxPrice: 2000000,
